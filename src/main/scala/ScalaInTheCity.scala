...
// https://github.com/adamgfraser/0-to-100-with-zio-test/blob/master/src/main/scala/ScalaInTheCity.scala
object ScalaInTheCity extends App {
  ...
  object Github {
    ...
    val live: ZLayer[SttpClient, Nothing, Github] =
      ZLayer.fromService { sttpClient: SttpBackend[Task, Nothing, WebSocketHandler] =>
        new Service {
          def getRepos(language: String, limit: Int): Task[List[Repo]] = {
